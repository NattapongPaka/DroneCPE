...
public final class AccelerometerView extends View  {
	...
	private static final String TAG = AccelerometerView.class.getSimpleName();
	...
	private void initDrawingTools() {
		...
		rimPaint.setColor(getResources().getColor(R.color.SkyBlue));
		...
		rimOuterPaint.setColor(Color.RED);
		...
		skyPaint.setColor(getResources().getColor(R.color.Brown));
	...
	private void drawFace(Canvas canvas) {
		...
		int height = (int) ((faceBitmap.getHeight() / 2) - ((faceBitmap.getHeight() / 2.5) * rotation[1]));

		if (height > faceBitmap.getHeight()) {
			height = faceBitmap.getHeight();
		}

		faceBitmap.setPixels(allpixels, 0, faceBitmap.getWidth(), 0, 0,faceBitmap.getWidth(), height);
